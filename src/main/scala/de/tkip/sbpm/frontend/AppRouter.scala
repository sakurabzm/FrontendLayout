...
object AppRouter extends JSApp {
  ...
  case object SubjectsVP extends AppPage
  ...
  val config = RouterConfigDsl[AppPage].buildConfig { dsl =>
    ...
    (emptyRule
      ...
      | staticRoute("#subjectsView", SubjectsVP) ~> render(SubjectsV.component())         // HU
      |staticRoute("#internalBehavior", InternalBH) ~> render(InternalBehaviorPage.component()) // HU
